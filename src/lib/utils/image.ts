...
// Canonical Firebase Storage download URLs (note the bucket ends with .appspot.com)
export const IMAGES = {
  // Logo and branding
  SIGNATURE_LOGO:
    'https://firebasestorage.googleapis.com/v0/b/endless-fire-467204-n2.appspot.com/o/Signaturelogbl.png?alt=media&token=763a8bc9-b77d-48b3-bc39-ee64c8f9b03c',

  // Author photos
  AUTHOR_PORTRAIT:
    'https://firebasestorage.googleapis.com/v0/b/endless-fire-467204-n2.appspot.com/o/August25.png?alt=media&token=ae2aa914-5e2e-4519-9749-077037b54e58',

  AUTHOR_FIREFIGHTER:
    'https://firebasestorage.googleapis.com/v0/b/endless-fire-467204-n2.appspot.com/o/CharlesBoswell_USFS.jpg?alt=media&token=46388a4c-27d2-4da6-9ad3-9d4c9b279e05',
  ...
  BOOKS: {
    ...
    HEART_OF_the_STORM:
      'https://firebasestorage.googleapis.com/v0/b/endless-fire-467204-n2.appspot.com/o/Heart_of_the_Storm_Elf_and_Wolf.png?alt=media&token=5376fbb7-b0e4-4595-abc8-6ec96be68005'
  }
} as const;

// Optional: normalize any legacy URLs you might still have around
...
/** Simple fallback image (SVG data URL) */
