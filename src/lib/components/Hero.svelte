<script lang="ts">
  ...
  export let subtitle: string = "From Navy decks to wildfire frontlines, now crafting tales of courage, brotherhood, and elemental magic.";
  export let bookCover: string = "/api/placeholder/300/450";
  export let ctaText: string = "Read Latest Book";
  export let ctaLink: string = "/books";
  
  const iconUrl = "https://firebasestorage.googleapis.com/v0/b/endless-fire-467204-n2.firebasestorage.app/o/Charle_Boswell_Christian_Fiction_icon.png?alt=media&token=ee498640-61e5-4a6f-8410-9684bb1624d1";
</script>
