...
<section class="py-20 bg-white">
  <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="text-center mb-16">
      <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6">About the Author</h1>
      <p class="text-xl text-gray-600">
        From military service to fighting wildfires, every experience shapes the stories I tell.
      </p>
    </div>
      ...
      <div class="grid lg:grid-cols-3 gap-12 mb-16">
        ...
        <div class="space-y-6">
          <div class="bg-gray-50 p-6 rounded-lg">
            ...
            <p class="text-gray-600">U.S. Navy veteran with deployment experience</p>
          </div>
          
          <div class="bg-gray-50 p-6 rounded-lg">
            <h3 class="font-bold text-gray-900 mb-2">Firefighting Career</h3>
            <p class="text-gray-600">16 years battling wildfires across the American West</p>
          </div>
          
          <div class="bg-gray-50 p-6 rounded-lg">
            <h3 class="font-bold text-gray-900 mb-2">Writing Focus</h3>
            <p class="text-gray-600">Epic fantasy with military precision and elemental magic</p>
          </div>
        </div>
      </div>
