<script lang="ts">
  ...
  // CRITICAL FIX: Properly type the data export
  ...
  const fallbackBooks: Book[] = [
    {
      ...
      cover: IMAGES.BOOKS.FAITH_IN_A_FIRESTORM, // ✅ Now uses your actual Firebase URL
      genre: 'faith',
      status: 'featured',
      buyLinks: {
    ...
    },
    {
      ...
      cover: IMAGES.BOOKS.CONVICTION_IN_A_FLOOD, // ✅ Now uses your actual Firebase URL
      genre: 'faith',
      status: 'upcoming',
    ...
    },
    {
      ...
      cover: IMAGES.BOOKS.HURRICANE_EVE, // ✅ Now uses your actual Firebase URL
      genre: 'faith',
      status: 'upcoming',
    ...
    },
    {
      ...
      description: 'David Paczer, thrust into a brutal medieval world where the Church\'s armies force conversion by sword.',
      cover: IMAGES.BOOKS.THE_FAITH_OF_THE_HUNTER, // ✅ Now uses your actual Firebase URL
      genre: 'faith',
      status: 'upcoming',
    ...
    },
    {
      ...
      description: 'An epic fantasy of corruption, rebirth, and resilience when worlds collide.',
      cover: IMAGES.BOOKS.HEART_OF_THE_STORM, // ✅ Now uses your actual Firebase URL
      genre: 'epic',
      status: 'upcoming',
  ...
  // CRITICAL FIX: Safe data access with proper fallback
  ...
  // Get unique statuses from actual books data for filter options
  $: availableStatuses = [...new Set(books.map(book => book.status).filter(Boolean))];
</script>
...
<svelte:head>
  ...
  <meta property="og:title" content="Books by Charles W. Boswell — Christian Fantasy & Epic Fantasy" />
  <meta property="og:description" content="Stories of courage, faith, and brotherhood forged from real military and firefighting experiences." />
</svelte:head>
    ...
    {:else}
      ...
      <div class="text-center py-16">
        ...
        <p class="text-lg text-gray-600 mb-6">
          No books match your current filter selection.
        </p>
        <button 
